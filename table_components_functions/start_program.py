...
def initialize_table(table_layout):
    ...
    for header in headers:
        table_layout.add_widget(Label(text=header, size_hint_y=None, height=20, font_size="12sp"))

    # Добавляем начальную строку с данными
    table_layout.add_widget(Label(text="0", size_hint_y=None, height=20))
    table_layout.add_widget(Label(text="Пустой", size_hint_y=None, height=20))
    table_layout.add_widget(Label(text="2", size_hint_y=None, height=20))
